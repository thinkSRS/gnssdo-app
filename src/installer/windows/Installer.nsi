...
;Pages
  ...
  !define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the installation of the ${app_name} from ${author}.$\r$\n$\r$\n$\r$\nClick Next to continue."
  ...
  !insertmacro MUI_PAGE_INSTFILES
    ...
    !define MUI_FINISHPAGE_RUN_TEXT "Run the ${app_name}"
